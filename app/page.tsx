          ...
          <CardContent className="p-6">
            ...
            <div className="mb-6 p-4 bg-background/20 backdrop-blur-lg rounded-lg border border-default-200/50">
              ...
              <p className="text-muted-foreground text-sm">
                Based on recent performance, your strategy shows a strong win
                rate but could benefit from optimizing average risk-to-reward.
                Consider adjusting trade sizes to maximize profits while keeping
                drawdown low.
              </p>
            </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="p-4 bg-background/20 backdrop-blur-lg rounded-lg border border-default-200/50">
              ...
              <p className="text-sm text-muted-foreground">
                Yesterday the market was quite flat. I refrained from trading
                and focused more on software projects. Tomorrow, when I return
                to the charts, I hope to stay disciplined and avoid low-volume
                trades. Every day that I journal helps me follow my rules and
