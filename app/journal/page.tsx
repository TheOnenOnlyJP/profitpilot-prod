  ...
  const journalEntries: JournalEntry[] = [
    {
      ...
      date: '2024-03-18',
      wordCount: 430,
      content: "Yesterday the market was quite flat. I refrained from trading and focused more on software projects. Tomorrow, when I return to the charts, I hope to stay disciplined and avoid low-volume trades.",
      trades: [
    ...
    },
    {
      ...
      date: '2024-03-17',
      wordCount: 285,
      content: "Focused on USD pairs today due to high impact news. Managed to catch a good move on EUR/USD.",
      trades: [
        { pair: 'EUR/USD', result: 'win', pips: 22 }
      ],
      mood: 'positive'
    }
  ];
            ...
            <AccordionContent>
              <div className="p-4">
                <div className="flex justify-between items-start">
                  {/* Date Range Filters */}
                  <div>
                    <h3 className="text-sm font-medium mb-2 text-foreground">Date Range</h3>
                    <div className="flex gap-6">
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => handleFiltersChange('last_week', e.target.checked)}
                          className="mr-3"
                        />
                        <label htmlFor="last-week" className="text-foreground flex items-center gap-3">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => handleFiltersChange('this_week', e.target.checked)}
                          className="mr-3"
                        />
                        <label htmlFor="this-week" className="text-foreground flex items-center gap-3">
                          <Calendar className="h-4 w-4" />
                          <span>This Week</span>
                        </label>
                      </div>
                  ...
                  <div>
                    <h3 className="text-sm font-medium mb-2 text-foreground">Trade Results</h3>
                    <div className="flex gap-6">
                      <div className="flex items-center">
                        <input
                          type="checkbox"
                          ...
                          onChange={(e) => handleFiltersChange('wins', e.target.checked)}
                          className="mr-3"
                        />
                        <label htmlFor="wins" className="text-foreground flex items-center gap-3">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={(e) => handleFiltersChange('losses', e.target.checked)}
                          className="mr-3"
                        />
                        <label htmlFor="losses" className="text-foreground flex items-center gap-3">
