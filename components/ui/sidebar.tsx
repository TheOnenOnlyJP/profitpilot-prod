  ...
  const navigation = [
    {
      section: 'Tools',
      items: [
        { name: 'Sign In', href: '/signin', icon: LogOut },
        ...
        <div className="px-6 pb-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-full rounded-lg bg-default-100 py-2 pl-10 pr-4 text-sm text-default-600 outline-none placeholder:text-default-400"
            />
          </div>
        </div>
      )}
